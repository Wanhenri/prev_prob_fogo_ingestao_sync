...
ano = 202507
modelo_previsao = 'CPTEC'
bioma = 'Pantanal'

BASE_DIR = Path(f'{path}/prev_prob_fogo/data/{ano}/{modelo_previsao}/')
BASE_DIR_BiomaPantanal = Path(f'{path}/prev_prob_fogo/data/shapefile/{bioma}/')
...
if __name__ == '__main__':
    ...
    def carregar_dados_do_banco(ufs, ordem_legenda):
        # URL do banco (coloque sua senha correta)
        engine_url = 'postgresql://neondb_owner:**********@ep-calm-sun-acqqs9yf-pooler.sa-east-1.aws.neon.tech/*******?sslmode=require&channel_binding=require'
        ...
        sql = f"""
        SELECT * FROM biomas.previsao_2025
